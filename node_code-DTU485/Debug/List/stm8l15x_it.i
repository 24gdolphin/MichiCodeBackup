...
typedef enum {
  ...
  RTC_IRQn                                 = (uint8_t)4,    
  EXTIB_IRQn                               = (uint8_t)6,    
  EXTID_IRQn                               = (uint8_t)7,    
  LCD_IRQn                                 = (uint8_t)16,   
	SWITCH_CSS_BREAK_DAC_IRQn                = (uint8_t)17,   
  TIM2_UPD_OVF_TRG_BRK_IRQn                = (uint8_t)19,   
  TIM2_CC_IRQn                             = (uint8_t)20,   
  TIM3_UPD_OVF_TRG_BRK_IRQn                = (uint8_t)21,   
  TIM3_CC_IRQn                             = (uint8_t)22,   
	TIM1_UPD_OVF_TRG_IRQn                    = (uint8_t)23,   
  TIM1_CC_IRQn                             = (uint8_t)24,   
  USART1_TX_IRQn                           = (uint8_t)27,   
  USART1_RX_IRQn                           = (uint8_t)28,   
  I2C1_IRQn                                = (uint8_t)29    
}IRQn_TypeDef;
...
#pragma language=restore
 ...
 __interrupt void RTC_CSSLSE_IRQHandler(void);  
 __interrupt void EXTIE_F_PVD_IRQHandler(void);  
 __interrupt void EXTIB_G_IRQHandler(void);  
 __interrupt void EXTID_H_IRQHandler(void);  
 ...
 __interrupt void LCD_AES_IRQHandler(void);  
 __interrupt void SWITCH_CSS_BREAK_DAC_IRQHandler(void);  
 __interrupt void ADC1_COMP_IRQHandler(void);  
 __interrupt void TIM2_UPD_OVF_TRG_BRK_USART2_TX_IRQHandler(void);  
 __interrupt void TIM2_CC_USART2_RX_IRQHandler(void);  
 __interrupt void TIM3_UPD_OVF_TRG_BRK_USART3_TX_IRQHandler(void);  
 __interrupt void TIM3_CC_USART3_RX_IRQHandler(void);  
 ...
 __interrupt void USART1_TX_TIM5_UPD_OVF_TRG_BRK_IRQHandler(void);  
 __interrupt void USART1_RX_TIM5_CC_IRQHandler(void);  
 __interrupt void I2C1_SPI2_IRQHandler(void);  
...
_Pragma( "vector = (1)" ) __interrupt void (TRAP_IRQHandler) (void)
{
...
_Pragma( "vector = ((1)+2)" ) __interrupt void (FLASH_IRQHandler)( void )
{
...
_Pragma( "vector = ((2)+2)" ) __interrupt void (DMA1_CHANNEL0_1_IRQHandler)( void )
{
...
_Pragma( "vector = ((3)+2)" ) __interrupt void (DMA1_CHANNEL2_3_IRQHandler)( void )
{
...
_Pragma( "vector = ((4)+2)" ) __interrupt void (RTC_CSSLSE_IRQHandler)( void )
{
...
_Pragma( "vector = ((5)+2)" ) __interrupt void (EXTIE_F_PVD_IRQHandler)( void )
{
...
_Pragma( "vector = ((6)+2)" ) __interrupt void (EXTIB_G_IRQHandler)( void )
{
...
_Pragma( "vector = ((7)+2)" ) __interrupt void (EXTID_H_IRQHandler)( void )
{
...
_Pragma( "vector = ((8)+2)" ) __interrupt void (EXTI0_IRQHandler)( void )
{
...
_Pragma( "vector = ((9)+2)" ) __interrupt void (EXTI1_IRQHandler)( void )
{
...
_Pragma( "vector = ((10)+2)" ) __interrupt void (EXTI2_IRQHandler)( void )
{
...
_Pragma( "vector = ((11)+2)" ) __interrupt void (EXTI3_IRQHandler)( void )
{
...
_Pragma( "vector = ((12)+2)" ) __interrupt void (EXTI4_IRQHandler)( void )
{
...
_Pragma( "vector = ((13)+2)" ) __interrupt void (EXTI5_IRQHandler)( void )
{
...
_Pragma( "vector = ((14)+2)" ) __interrupt void (EXTI6_IRQHandler)( void )
{
...
_Pragma( "vector = ((15)+2)" ) __interrupt void (EXTI7_IRQHandler)( void )
{
...
_Pragma( "vector = ((16)+2)" ) __interrupt void (LCD_AES_IRQHandler)( void )
{
...
_Pragma( "vector = ((17)+2)" ) __interrupt void (SWITCH_CSS_BREAK_DAC_IRQHandler)( void )
{
...
_Pragma( "vector = ((18)+2)" ) __interrupt void (ADC1_COMP_IRQHandler)( void )
{
...
_Pragma( "vector = ((19)+2)" ) __interrupt void (TIM2_UPD_OVF_TRG_BRK_USART2_TX_IRQHandler)( void )
{
...
_Pragma( "vector = ((20)+2)" ) __interrupt void (TIM2_CC_USART2_RX_IRQHandler)( void )
{
...
_Pragma( "vector = ((21)+2)" ) __interrupt void (TIM3_UPD_OVF_TRG_BRK_USART3_TX_IRQHandler)( void )
{
...
_Pragma( "vector = ((22)+2)" ) __interrupt void (TIM3_CC_USART3_RX_IRQHandler)( void )
{
...
_Pragma( "vector = ((23)+2)" ) __interrupt void (TIM1_UPD_OVF_TRG_COM_IRQHandler)( void )
{
...
_Pragma( "vector = ((24)+2)" ) __interrupt void (TIM1_CC_IRQHandler)( void )
{
...
_Pragma( "vector = ((25)+2)" ) __interrupt void (TIM4_UPD_OVF_TRG_IRQHandler)( void )
{
...
_Pragma( "vector = ((26)+2)" ) __interrupt void (SPI1_IRQHandler)( void )
{
...
_Pragma( "vector = ((27)+2)" ) __interrupt void (USART1_TX_TIM5_UPD_OVF_TRG_BRK_IRQHandler)( void )
{
...
_Pragma( "vector = ((28)+2)" ) __interrupt void (USART1_RX_TIM5_CC_IRQHandler)( void )
{
...
_Pragma( "vector = ((29)+2)" ) __interrupt void (I2C1_SPI2_IRQHandler)( void )
{
